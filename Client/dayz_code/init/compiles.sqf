...
if (!isDedicated) then {
	...
	local_gutAnimal =			compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\local_gutAnimal.sqf";		//Generated on the server (or local to unit) when gutting an object
